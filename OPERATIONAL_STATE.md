...
{"schema_version":1,"project_id":"aethervfx","project_name":"AetherVFX Ability and Procedural VFX Engine","project_root":"/mnt/data/aethervfx_work","artifact_path":"","state_revision":13,"last_updated":"2026-08-13T20:54:44Z","current_baseline":{"identity":"local source 3d5b92d46ed85efc0a018cf0a956130e5f09c8f5; remote source checkpoint 6f652628959b36f83362b447fe1cbf42fe809d55; later documentation commits do not change source identity","state":"current-baseline","last_verified":"2026-08-13T20:54:44Z"},"scope_boundaries":["AetherVFX local repo and westkitty/3js-VFX-platform"],"linked_parent_state":null}
-->
...
- Remote Phase 3 validation-hardening source: `6f652628959b36f83362b447fe1cbf42fe809d55`.
...
{"id":"INV-001","title":"Preserve seven-mode workbench","state":"requested","rule":"Keep all seven modes visible while shallow paths become truthful working or staged paths.","scope":"Workbench shell","authority":"Accepted assessment","evidence":"ROADMAP.md","validation_method":"Inspect mode routing","last_checked":"revision 13","status":"active","recheck_trigger":"Navigation change"}
-->
...
<!-- operational-state:entry
{"id":"INV-002","title":"No breadth before runtime truth","state":"requested","rule":"Do not add modes, schools, effect families, or renderer migrations while the active gate is unverified.","scope":"All implementation","authority":"Accepted assessment","evidence":"ROADMAP.md","validation_method":"Map work to current phase","last_checked":"revision 13","status":"active","recheck_trigger":"Explicit direction change"}
-->
...
<!-- operational-state:entry
{"id":"VER-005","title":"Indicator model validation published","state":"verified","capability":"All five local indicator outline families, parameter clamps, negative-dt handling, zero-duration handling, and deterministic warning/commit/clear timing are covered by an executable dependency-free check, and the manager consumes that tested model.","scope":"Indicator geometry/timing model and remote source publication","verification_method":"node scripts/indicator-model-check.cjs; TS/TSX syntax transpile; source-graph check; GitHub ref/file fetch","evidence":"Indicator model PASS; source graph PASS 61 files; TS/TSX syntax PASS 61 files; local 3d5b92d46ed85efc0a018cf0a956130e5f09c8f5; remote 6f652628959b36f83362b447fe1cbf42fe809d55","artifact_revision":"6f652628959b36f83362b447fe1cbf42fe809d55","last_verified":"2026-08-13T20:54:44Z","dependencies":"Global TypeScript compiler for local check; GitHub connector for publication proof","freshness":"current source checkpoint","recheck_trigger":"IndicatorModel, SurfaceIndicatorManager timing, or outline-shape change"}
-->
### VER-005 — Indicator model validation published
- **State:** `verified` — five shape families, clamping, deterministic phase timing, source graph, syntax, and remote publication are proven.
<!-- /operational-state:entry -->
...
<!-- operational-state:entry
{"id":"UNV-007","title":"Surface-aware freehand and indicators","state":"implemented-unverified","capability":"Local-normal projection, freehand reprojection, and five indicator shapes with timing are implemented.","evidence":"Phase 3 source plus fixture and verified IndicatorModel checks","validation_method":"Use ?surfaceFixture=1 on ramp/steps","recheck_trigger":"Surface/freehand/indicator/input change"}
-->
### UNV-007 — Surface-aware freehand and indicators
- **State:** `implemented-unverified` — pure outline/timing behavior is verified; real Three.js surface placement still needs `?surfaceFixture=1`.
<!-- /operational-state:entry -->

## 8. Unknown or Evidence-Stale State

<!-- operational-state:entry
{"id":"UNK-001","title":"Dependency-resolved runtime unverified","state":"unknown","decisive_check":"Install dependencies; run lint, runtime-spine, source-graph, indicator-model, build, then browser smoke.","evidence":"Current container has Chromium and global TypeScript but no project node_modules; npm install timed out and outbound package/CDN access is unavailable.","last_checked":"revision 13"}
-->
### UNK-001 — Dependency-resolved runtime unverified
- **State:** `unknown` — project dependencies cannot currently be installed here; decisive check remains dependency-resolved build + browser smoke.
<!-- /operational-state:entry -->
...
<!-- operational-state:entry
{"id":"DEC-001","title":"Assessment controls development order","state":"requested","rule":"Make existing modes truthful before breadth; follow ROADMAP.md; do not enter Phase 4 before PND-002 is resolved or explicitly accepted as a blocker.","scope":"All AetherVFX work","authority":"Explicit user confirmation","evidence":"Accepted assessment/roadmap","validation_method":"Map checkpoint to roadmap gate","last_checked":"revision 13","status":"active","recheck_trigger":"Explicit direction change"}
-->
...
|---|---|---|---|
| VER-005 | verified | local `3d5b92d`; remote `6f652628` | rerun indicator-model/source-graph/syntax + remote fetch |
...
| 12 | Indicator geometry/timing model extracted; large-dt phase stretching repaired; dependency-free checks pass. |
| 13 | Indicator model/manager/tests published on `main`; state reconciled to remote source checkpoint `6f652628`. |
